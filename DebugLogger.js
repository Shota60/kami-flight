...
class DebugLogger {
    ...
    updatePlaneVelocity(plane) {
        ...
        this.addLog(DebugLogger.LOG_KEYS.PLANE_HORIZ_SPEED, this.calculateHorizontalSpeedWithDirection(plane));
    }
    ...
    updateObstacleState(obstacleManager) {
        ...
        this.addLog(DebugLogger.LOG_KEYS.OBSTACLE_SPAWN_TIMER, Math.round(obstacleManager.obstacleSpawnTimer));
        this.addLog(DebugLogger.LOG_KEYS.OBSTACLE_SPAWN_INTERVAL, obstacleManager.obstacleSpawnInterval);
    }
