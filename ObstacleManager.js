class ObstacleManager {
    constructor(canvas, camera, goalY) {
        this.canvas = canvas;
        this.camera = camera;
        this.goalY = goalY;
        this.obstacles = [];
        ...
        this.initialObstacleSpawnInterval = 100;
        this.obstacleSpawnInterval = this.initialObstacleSpawnInterval;
        this.minObstacleSpawnInterval = 45;
    ...
    spawnObstacle() {
        ...
        const totalWeight = Object.values(this.obstacleTypes).reduce((sum, type) => sum + type.weight, 0);
    ...
    updateObstacles() {
        ...
        if (this.obstacleSpawnTimer >= this.obstacleSpawnInterval) {
            ...
            this.obstacleSpawnInterval = Math.max(this.minObstacleSpawnInterval, this.obstacleSpawnInterval - 1);
